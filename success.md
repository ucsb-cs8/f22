...
# How to Succeed in CSW/CS 8 (and other computing courses)
...
All due times in our class are at **11:59 PM Pacific time (23:59)** (on various days). To see which days the different assignments are due, CHECK THE SYLLABUS! Then add the days/times as recurring events on your Calendar.

---

✨ Pro Tip✨ : _**Do not try to complete all chapter sections in one sitting**_! We recommend spending **no more than 2 hours** in a row reading through the sections and completing the activities in zyBooks. Your brain will get tired and will need a break. Trust us: even seasoned programmers cannot meaningfully work through this material for more than 2 hours, so save yourself some time and allow for at least a 30-minute break between the study sessions. 
...
* In the search-box, paste the following: `"CMPSCW 8" OR "CSW 8"` (or alternatively, `"CS 8" OR "CMPSC 8"`)
* note that the capitals for the `OR` operator are important so that the search includes *both* terms
...
Do not underestimate the power of taking breaks and getting a good night's sleep to give your brain some much-needed rest.
